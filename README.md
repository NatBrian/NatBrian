...
- [**program-as-weights-github**](https://github.com/NatBrian/program-as-weights-github) — Program-as-Weights, reimplemented: compile an English fuzzy-function spec once into a tiny LoRA+pseudo-program a frozen 0.6B model runs offline. Applied to real GitHub issues/PRs. • `Python` • ★ 1 • 🍴 1
- [**agent-pair-studio**](https://github.com/NatBrian/agent-pair-studio) — Autonomous pair-programming arena between Kilo CLI and Cline CLI • `JavaScript` • ★ 0 • 🍴 0
...
- [**T-ECD-Sequential-Recommender**](https://github.com/NatBrian/T-ECD-Sequential-Recommender) — Sequential Recommender (SASRec/GRU) benchmarking the T-ECD dataset (9.2M events). Features interactive testing dashboards, 2D/3D cross-domain embedding visualizations, and impact analysis. • `Jupyter Notebook` • ★ 1 • 🍴 0 • Topics: embeddings, gru, gru4rec, notebook, pytorch, recommendation-system, recommender-system, rnn, sasrec, transformer
